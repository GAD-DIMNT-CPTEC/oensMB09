...
C
      INCLUDE "reshalb.h"
C
      PARAMETER (LATIN=46,LONIN=72,LATOUT=JMAX,LONOUT=IMAX,
...
C
      REAL*4 ALBGRD(LONOUT,LATOUT),ALCGRD(LONIN,LATIN)
C
...
C
      ...
      DO J=1,LATIN
      DO I=1,LN
      ALCGRD(I,J)=FIELDA(LN+I,J)
      ALCGRD(LN+I,J)=FIELDA(I,J)
      ENDDO
      ENDDO
      WRITE(21) ALCGRD
  100 CONTINUE
