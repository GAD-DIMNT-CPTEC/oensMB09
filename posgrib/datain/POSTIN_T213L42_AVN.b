...
!
 &PosInput
  ...
  Linear=.FALSE.,      ! Flag to Gaussian grid type Linear (.TRUE.) or 
                       !                            Quadratic (.FALSE.)
  trunc ='T213',       ! horizontal truncation = Txxx
  lev   ='L42',        ! vertical layers = Lxx
  labeli='2007062800', ! initial forecasting label (yyyymmddhh)
  labelf='2007071300', ! final forecasting label (yyyymmddhh)
  prefx ='AVN',        ! preffix for input and output files
  req   ='p',          ! flag to select requested field file (p, s, c, e or nothing)
                       ...
                       !   code in future)
  datain='/gfs/dk19/io_dop/users/alex/oenspro/model/dataout/T213L42', ! main dataout directory
  datalib='/gfs/home3/io_dop/users/alex/oenspro/model/posgrib/datain',   ! main dataout directory
