...
!
 &PosInput
  ...
  Linear=.FALSE.,      ! Flag to Gaussian grid type Linear (.TRUE.) or 
                       !                            Quadratic (.FALSE.)
  trunc ='T',       ! horizontal truncation = Txxx
  lev   ='L',        ! vertical layers = Lxx
  labeli='2007062700', ! initial forecasting label (yyyymmddhh)
  labelf='2007062800', ! final forecasting label (yyyymmddhh)
  ...
  req   ='p',          ! flag to select requested field file (p, s, c, e or nothing)
                       ...
                       !   code in future)
  datain='/gfs/dk19/io_dop/users/alex/oenspro/model/dataout/TL', ! main dataout directory
