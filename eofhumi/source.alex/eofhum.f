...
C*
C*      INTEGER IMAX,JMAX,MEND,KMAX,LMAX
C*      PARAMETER (IMAX=384,JMAX=192,KMAX=28)
C*      PARAMETER (MEND=126,LMAX=11)
...
C*
      ...
      write(*,*)'sigma2(',K,')=',sigma2(K),SIGMA2(K),TP(I,J,K),TMNK(K),TP(I,J,K),TMNK(K)
      ENDDO
      ENDDO
