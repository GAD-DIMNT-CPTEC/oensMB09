...
!
  CALL BAOPEN(51,name(1:lengh1),ierr)
  if (ierr .ne. 0) write(6,*) 'output baopen error!'
   call putgben(51,kf,kpdso,kgdso,kenso,ibs,nbits,lisum,sum,iret)
...
!
  CALL BAOPEN(51,name(1:lengh1),ierr)
  if (ierr .ne. 0) write(6,*) 'output baopen error!'
   call putgben(51,kf,kpds,kgds,kens,ibs,nbits,li,dummy,iret)
   if (iret .ne. 0) write(6,*) 'putgben error!'
  CALL BACLOSE(51,ierr)
