...
*say 'printim 'dirfig''state'/'lab''label'.gif gif x620 y760'
*'!mkdir -p 'dirfig''state
*'printim 'dirfig''state'/'lab''label'.gif gif x620 y760'
*say '!/usr/X11R6/bin/convert -crop 0x0 'dirfig''state'/'lab''label'.gif 'dirfig''state'/'lab''label'.gif'
*'!/usr/X11R6/bin/convert -crop 0x0 'dirfig''state'/'lab''label'.gif 'dirfig''state'/'lab''label'.png'
*'!rm -f 'dirfig''state'/'lab''label'.gif '

say 'printim 'dirfig''state'/'lab'.png png x620 y760'
'printim 'dirfig''state'/'lab'.png png x620 y760'
say '!/usr/X11R6/bin/convert -crop 0x0 'dirfig''state'/'lab'.png 'dirfig''state'/'lab'.png'
'!/usr/X11R6/bin/convert -crop 0x0 'dirfig''state'/'lab'.png 'dirfig''state'/'lab'.png'
*'!rm -f 'dirfig''state'/'lab'.png '
