...
#   File     :  makeprobagr
#
#   This makefile creates optimized executables of the week mean precipitation probability
#
#   Set object files.
#
#
...
F90FLAGS =        -convert big_endian #-float0 -ew
CMD =              /scratch1/home/oper/oens_MCGA/produtos/probagr/bin/probagr.x
