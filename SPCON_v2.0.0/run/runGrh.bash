...
SCRIPTFILEPATH=${EXECFILEPATH}/grhg${DIRRESOL}.${MAQUI}
NAMELISTFILEPATH=${HOME_suite}/run ; mkdir -p ${HOME_suite}/run/setout
OUTPUTFILEPATH=${HOME_suite}/run/setout/grhg${DIRRESOL}.${MAQUI}.${RUNTM}.out
...
#!/bin/bash
#PBS -o ${host}:${EXECFILEPATH}/setout/Out.grh.${labeli}.${tmstp}.%s.MPI${cpu_mpi}.out
#PBS -j oe
...
$ ${EXECFILEPATH}/PostGridHistory < ${EXECFILEPATH}/PostGridHistory.nml
else
...
if [ $GSSTEP = 1 ]; then
/opt/grads/2.0.a9/bin/grads -bpc  << EOT
