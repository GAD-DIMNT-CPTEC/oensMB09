...
echo runperreco.${MACHINE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT}
...
#
echo "${OPERM}/runperreco.${MACHINE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT} "
${OPERM}/run/runperreco.${MACHINE} ${COMPILE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT}
#
