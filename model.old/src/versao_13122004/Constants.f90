...
MODULE Constants
  ...
  INTEGER (KIND=i8), PARAMETER :: ndavl = 85  ! Number of Available Diagnostics Fields
  INTEGER (KIND=i8), PARAMETER :: ndrq  = 100 ! Number of Desired Diagnostics Fields
  INTEGER (KIND=i8), PARAMETER :: ncdg  = 20  ! Number of Combined Field Components
  INTEGER (KIND=i8), PARAMETER :: jxavl = 150 ! Maximum Number of Available plus Combined Fields
  INTEGER (KIND=i8), PARAMETER :: jxcdg = 40  ! Maximum Number of Combined Field Components

                                           ! Dimension for Grid History Arrays
  INTEGER (KIND=i8), PARAMETER :: ngfld=79 ! Number of Available Grid History Fields

                                                      ! Dimension for Units Arrays
  INTEGER (KIND=i8), PARAMETER :: nunits = 230        ! Number of Defined Units
  INTEGER (KIND=i8), PARAMETER :: numx   = nunits-1   ! Number of Defined Units minus 1
  INTEGER (KIND=i8), PARAMETER :: ngrp   = nunits/10  ! Number of Units Groups
  INTEGER (KIND=i8), PARAMETER :: ngrmx  = ngrp-1     ! Number of Units Groups minus 1
  INTEGER (KIND=i8), PARAMETER :: ncf    = 1000       ! Number of First Unit Conversion Coefficents
  INTEGER (KIND=i8), PARAMETER :: ncf2   = 500        ! Number of Second Unit Conversion Coefficents

                                            ! Dimension for Vegetation Arrays
  INTEGER (KIND=i8), PARAMETER :: ityp = 13 ! Number of Vegetation Types
  INTEGER (KIND=i8), PARAMETER :: imon = 12 ! Number of Months with Defined Vegetation Types
  INTEGER (KIND=i8), PARAMETER :: icg  = 2  ! Number of Vegetation Parameters
  INTEGER (KIND=i8), PARAMETER :: iwv  = 3  ! Number of Radiation Wavelengths
  INTEGER (KIND=i8), PARAMETER :: idp  = 3  ! Number of Soil Layer Parameters
  INTEGER (KIND=i8), PARAMETER :: ibd  = 2  ! Number of Vegetation Stage
