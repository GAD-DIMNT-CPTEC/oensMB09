...
*  'printim 'dirfig'prec'labeli''labelf'.gif gif x900 y700'
  'printim 'dirfig'prec'labeli''labelf'.gif gif x773 y602'
  '!/usr/X11R6/bin/convert -crop 0x0 'dirfig'prec'labeli''labelf'.gif 'dirfig'prec'labeli''labelf'.png'
  '!rm -f 'dirfig'prec'labeli''labelf'.gif'
*  'quit'
   nf=nf+1
endwhile
