...
PROGRAM VegetationMaskSiB2
   ...
   ! Land Sea Mask : Input
   PRINT *, "Land Sea Mask : Input"
   PRINT *, TRIM(DirInp)//"/"//NameLSM//nLats
   ...
   PRINT *, "Read In Input VegetationMaskSiB2"
   PRINT *, TRIM(DirInp)//"/"//TRIM(VarName)//'.dat'
   ...
   PRINT *, "Write Out Adjusted Interpolated VegetationMaskSiB2"
   PRINT *, TRIM(DirOut)//"/"//TRIM(VarNameVeg)//nLats
   ...
   PRINT *, "Land Sea Mask : Output"
   PRINT *, TRIM(DirOut)//"/"//NameLSMSSiB//nLats
