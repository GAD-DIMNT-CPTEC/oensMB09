...
_nomeb='/scratchout/oper/io/oensMB09/pos/dataout/TQ0126L028/2013121912/PreffixNMC'%_labeli%_labelf%'.'%_trlv

* nomes dos arquivos com identificacao e local dos pontos
_nomec='/scratchout/oper/io/oensMB09/pos/dataout/TQ0126L028/2013121912/IdentifNMC'%_labeli%_labelf%'.'%_trlv
_nomed='/scratchout/oper/io/oensMB09/pos/dataout/TQ0126L028/2013121912/LocalizNMC'%_labeli%_labelf%'.'%_trlv
nomectl ='/scratchout/oper/io/oensMB09/pos/dataout/TQ0126L028/2013121912/'%_nomea%_labeli%_labelf%'M.grh.'%_trlv%'.ctl'
*say nomectl
...
say 'nloc ' nloc  _loc
   ...
   routine=dimet()
   if (_faz=1)
      lixo=write('/scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/umrs_min'_labeli'.txt',_linha)
      lixo=write('/scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/umrs_min'_labeli'.txt','')
   endif  
endwhile
lixo=close('/scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/umrs_min'_labeli'.txt')
...
say 'printim /scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/'lab'.png png'
'printim /scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/'lab'.png png' 
'!rm -f meteogram'
if (_loc=1)
...
while (n<=_nlonlat2ur)
   ...
   if (lonlat=latlonur)
      lixo=write('/scratchout/oper/io/oensMB09/produtos/grh/TQ0126L028/2013121912/umrs_min'_labeli'.txt',lonlat' - 'local)
      _faz=1
      _linha=""
      n=9999
   endif
