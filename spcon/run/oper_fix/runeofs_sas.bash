...
;;
126) MR=126 ; IR=384 ; JR=192 ; II=266 ; IS=362 ; NI=97 ; JI=109 ; JS=161 ; NJ=53 ; 
     IIPS=266 ; ISPS=316 ; JIPS=109 ; JSPS=160 ; REG=sas ; 
     case ${LV} in
     09) KR=09 ; LR=11 ;;
     18) KR=18 ; LR=11 ;;
     28) KR=28 ; LR=11 ;;
...
SCRIPTNAME=seteofs_sas.${PREFIC}${RESOL}${NIVEL}.${LABELI}
