...
;;
126) MR=126 ; IR=384 ; JR=192 ; II=1 ; IS=384 ; NI=384 ; JI=118 ; JS=192 ; NJ=75 ; 
     IIPS=192 ; ISPS=299 ; JIPS=118 ; JSPS=153 ; REG=hs ; 
     case ${LV} in
     09) KR=09 ; LR=11 ;;
     18) KR=18 ; LR=11 ;;
     28) KR=28 ; LR=11 ;;
...
SCRIPTNAME=seteofs_hs.${PREFIC}${RESOL}${NIVEL}.${LABELI}
