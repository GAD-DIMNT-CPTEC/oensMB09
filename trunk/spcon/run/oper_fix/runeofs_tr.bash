...
;;
126) MR=126 ; IR=384 ; JR=192 ; II=1 ; IS=384 ; NI=384 ; JI=76 ; JS=117 ; NJ=42 ; 
     IIPS=192 ; ISPS=299 ; JIPS=76 ; JSPS=117 ; REG=tr ; 
     case ${LV} in
     09) KR=09 ; LR=11 ;;
     18) KR=18 ; LR=11 ;;
     28) KR=28 ; LR=11 ;;
...
SCRIPTNAME=seteofs_tr.${PREFIC}${RESOL}${NIVEL}.${LABELI}
...
cat <<EOT1 > eoftem${REG}\${NUM}.nml
 ...
 &STTEMP
  ...
  STDT(26)=1.50,STDT(27)=1.50,STDT(28)=1.50,STDT(29)=1.50,STDT(30)=1.50,
  STDT(31)=1.50,STDT(32)=1.50,STDT(33)=1.50,STDT(34)=1.50,STDT(35)=1.50,
  STDT(36)=1.50,STDT(37)=1.50,STDT(38)=1.50,STDT(39)=1.50,STDT(40)=1.50,
  STDT(41)=1.50,STDT(42)=1.50
 &END
 &PARMET
  IINF=${II},ISUP=${IS},IMAX0=${NI},
  JINF=${JI},JSUP=${JS},JMAX0=${NJ},
...
cat <<EOT1 > eofhum${REG}\${NUM}.nml
 ...
 &END
 &STHUMI
  STDQ( 1)= 0.770,STDQ( 2)= 0.780,STDQ( 3)= 0.780,STDQ( 4)= 0.820,
  STDQ( 5)= 0.800,STDQ( 6)= 0.980,STDQ( 7)= 1.030,STDQ( 8)= 1.080,
  STDQ( 9)= 1.130,STDQ(10)= 1.180,STDQ(11)= 1.050,STDQ(12)= 0.787,
  STDQ(13)= 0.523,STDQ(14)= 0.260,STDQ(15)= 0.195,STDQ(16)= 0.130,
  STDQ(17)= 0.065,STDQ(18)= 0.000,STDQ(19)= 0.000,STDQ(20)= 0.000,
  STDQ(21)= 0.000,STDQ(22)= 0.000,STDQ(23)= 0.000,STDQ(24)= 0.000,
  STDQ(25)= 0.000,STDQ(26)= 0.000,STDQ(27)= 0.000,STDQ(28)= 0.000,
  STDQ(29)= 0.000,STDQ(30)= 0.000,STDQ(31)= 0.000,STDQ(32)= 0.000,
  STDQ(33)= 0.000,STDQ(34)= 0.000,STDQ(35)= 0.000,STDQ(36)= 0.000,
  STDQ(37)= 0.000,STDQ(38)= 0.000,STDQ(39)= 0.000,STDQ(40)= 0.000,
  STDQ(41)= 0.000,STDQ(42)= 0.000
 &END
 &PARMET
  IINF=${II},ISUP=${IS},IMAX0=${NI},
  JINF=${JI},JSUP=${JS},JMAX0=${NJ},
...
cat <<EOT1 > eofwin${REG}\${NUM}.nml
 ...
 &STZWIN
  ...
  STDU(26)=5.00,STDU(27)=5.00,STDU(28)=5.00,STDU(29)=5.00,STDU(30)=5.00,
  STDU(31)=5.00,STDU(32)=5.00,STDU(33)=5.00,STDU(34)=5.00,STDU(35)=5.00,
  STDU(36)=5.00,STDU(37)=5.00,STDU(38)=5.00,STDU(39)=5.00,STDU(40)=5.00,
  STDU(41)=5.00,STDU(42)=5.00
 &END
 &STMWIN
  ...
  STDV(26)=5.00,STDV(27)=5.00,STDV(28)=5.00,STDV(29)=5.00,STDV(30)=5.00,
  STDV(31)=5.00,STDV(32)=5.00,STDV(33)=5.00,STDV(34)=5.00,STDV(35)=5.00,
  STDV(36)=5.00,STDV(37)=5.00,STDV(38)=5.00,STDV(39)=5.00,STDV(40)=5.00,
  STDV(41)=5.00,STDV(42)=5.00
 &END
 &HUMIDI
  HUM='${HUMID}'
 &END
...
SCRIPTNAME=seteofs_tr.1.${PREFIC}${RESOL}${NIVEL}.${LABELI}.${MACHINE}
export PBS_SERVER=aux20-eth4
...
#************************************************************#
#
#PBS -o ${HSTMAQ}:${ROPERM}/eof/output/seteofs.${PREFIC}.${LABELI}.${RUNTM}.${EXT}
#PBS -j oe
...
#   Set C pre-processing flags
#
mkdir -p \${OPERMOD}/include/${RESOL}${NIVEL}
...
# 
#
#mkdir -p  ${ROPERM}/model/dataout/${RESOL}${NIVEL}
cd ${ROPERM}/model/dataout/${RESOL}${NIVEL}/\${LABELI}
ext=R.fct.${RESOL}${NIVEL}
echo ${ext}
rm -f lst.GFCT${REG}\${NUM}R\${LABELI}.dr
ls -1 GFCT\${NUM}R\${LABELI}* > lst.GFCT${REG}\${NUM}R\${LABELI}.dr
awk '{ print \$1 }' lst.GFCT${REG}\${NUM}R\${LABELI}.dr  >  lst.GFCT${REG}\${NUM}R\${LABELI}
xx=\`awk '{ print substr(\$1,18,10) }' lst.GFCT${REG}\${NUM}R\${LABELI}\`
echo ${xx}
rm -f lst.GFCT${REG}\${NUM}R\${LABELI}.dr lst.GFCT${REG}\${NUM}R\${LABELI}

cd ${SOPERM}/eof/datain
\rm templ${REG}\${NUM}\${LABELI} 
for i in \${xx} 
do
cat <<EOT1 >> templ${REG}\${NUM}\${LABELI}
...
\${OPERMOD}/eofpres/scripts/eofpres.scr
...
cat <<EOT1 > eoftem${REG}\${NUM}.nml
 &DATAIN
  DIRI='\${SOPERMOD}/eof/datain/ '
  DIRA='\${ROPERMOD}/recanl/dataout/${RESOL}${NIVEL}/ '
  DIRO='\${ROPERMOD}/eof/dataout/${RESOL}${NIVEL}/ '
  NAMEL='templ${REG}\${NUM}\${LABELI} '
  ANAME='GANLAVN\${LABELI}\${ext}.${RESOL}${NIVEL} '
  TEMOUT='temout${REG}\${NUM}\${LABELI} '
  TEMPCM='tempcm${REG}\${NUM}\${LABELI} '
 &END
 &TEMPER
...
#
#
#AMM echo "qsub -x -s /bin/ksh -q ${QUEUE} ${OPERM}/run/seteofs.1.${PREFIC}${RESOL}${NIVEL}.${MACHINE}"
#AMM qsub -x -s /bin/ksh -q ${QUEUE} ${OPERM}/run/seteofs.1.${PREFIC}${RESOL}${NIVEL}.${MACHINE}
...
SECOND=`qsub -W depend=after:$FIRST ${OPERM}/run/${SCRIPTNAME}`
echo $SECOND
export JID=${SECOND}
fi
...
while [ ${itt} -gt 0 ];do
sleep 20
itt=`qstat_aux |grep ${USER} | grep ENSEOFS_TR${NUM}| wc -l`
itt2=`qstat | grep ${USER} | grep ENSEOFS_TR${NUM}| wc -l`
let itt=${itt}+${itt2}
done
fi
