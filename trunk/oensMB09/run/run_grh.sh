...
export PATHIN=${DK_suite}/model/dataout/${DIRRESOL}/${LABELI}/
export PATHOUT=${DK_suite}/pos/dataout/${DIRRESOL}/${LABELI}/
...
time \${EXECFILEPATH}/PostGridHistory < \${EXECFILEPATH}/PostGridHistory.nml > \${EXECFILEPATH}/setout/Print.grh.${LABELI}.MPI${MPPWIDTH}.log
EOF0
...
#/opt/grads/2.1.a1/bin/grads -bp << EOT
