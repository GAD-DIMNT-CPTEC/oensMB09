...
nomectls=nctl_icn' 'nctl_fct' 'nctl_fctold
variaveis='psnm temp(lev=1000) umrl(lev=925) umrl(lev=850) zgeo(lev=500) prec'
output='Pseanlm Tmp1000 Umrl925 Umrl850 Th5a10p Precipt'
...
'set map 1 1 5';'set mpdset brmap_mres'
'set clevs '_clvs
'set ccols '_cor
'set clab on'
if (_preench="contour")
