...
*
     ...
     'printim '_DIRGIF'/cluster'VAR''VAR2''PLEV''_DATEI.NCT''_DATEF.NCT'.gif gif x800 y1000'
*     'printim '_DIRGIF'/cluster'VAR''VAR2''PLEV''_DATEI.NCT''_DATEF.NCT'.gif gif x640 y800'
     '!/usr/X11R6/bin/convert -crop 0x0 '_DIRGIF'/cluster'VAR''VAR2''PLEV''_DATEI.NCT''_DATEF.NCT'.gif  '_DIRGIF'/cluster'VAR''VAR2''PLEV''_DATEI.NCT''_DATEF.NCT'.png'
     'rm -f '_DIRGIF'/cluster'VAR''VAR2''PLEV''_DATEI.NCT''_DATEF.NCT'.gif  '
