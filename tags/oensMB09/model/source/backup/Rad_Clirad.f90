...
CONTAINS
  ...
  !==========================================================================
    ...
    ELSE IF(icld.eq.4) THEN
       ...
       DO i=1,nsol
          tauk  (i,2:kmax+1) = taud(litx(i),1:kmax)
          frcice(i,2:kmax+1) = fice(litx(i),1:kmax)
          radice(i,2:kmax+1) = rei (litx(i),1:kmax)
          radliq(i,2:kmax+1) = rel (litx(i),1:kmax)
       ENDDO
