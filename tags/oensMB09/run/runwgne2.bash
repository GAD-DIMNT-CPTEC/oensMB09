...
mkdir -p ${SC2_suite}/pos/dataout/${CASE}/${LABELI}/ ${SC2_suite}/produtos/wgne/dataout/${CASE}/${LABELI}/
ln -sf /stornext/online7/pnt/preoper/tempo/oensMB09/${LABELI:0:6}/${LABELI:6:4}/???/GPOS* ${SC2_suite}/pos/dataout/${CASE}/${LABELI}/
L2=$(date -d "${LABELI:0:8} ${LABELI:8:2}:00 1 day ago" +"%Y%m%d%H")
mkdir -p ${SC2_suite}/pos/dataout/${CASE}/\${L2}/
ln -sf /stornext/online7/pnt/preoper/tempo/oensMB09/\${L2:0:6}/\${L2:6:4}/???/GPOS* ${SC2_suite}/pos/dataout/${CASE}/${LABELI}/
