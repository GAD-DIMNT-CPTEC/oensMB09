...
C*
      include "recanl.h"
C*
      INTEGER MEND1,MEND2,MNWV2,MNWV3,K1
      PARAMETER (MEND1=MEND+1,MEND2=MEND+2,
     *           MNWV2=MEND1*MEND2,
     *           MNWV3=MNWV2+2*MEND1)
C*
      INTEGER MN,J,I,K,L,IDL,IDS,IDR,IGL,IGS,IGR,IGR2
      REAL RD
...
C*
     ...
     *     GLAT(JMAX),CLAT(JMAX)
      REAL TP(IMAX,JMAX),LNPS(IMAX,JMAX)
...
C*
      ...
      CALL RECTRG(QGZS,TP,MNWV2, 1)
      CALL RECTRG(QLNP,LNPS,MNWV2, 1)
      DO K=1,KMAX
      DO J=1,JMAX
      DO I=1,IMAX
