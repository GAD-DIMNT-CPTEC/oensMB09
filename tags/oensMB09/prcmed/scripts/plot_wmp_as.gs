...
say '++++ 'nweek' - 'fct' - 't
*AAF 'printim 'dirfig'lprec_anomaly_as'datei''datef.t'.png png x800 y600'
'printim 'dirfig'prec_anomaly_'t'week.png png x800 y600'
'printim 'dirfig'prec_anomaly_as'datei''datef.t'.png png x640 y480'
'!'dirscr'convert2 -crop 0x0 'dirfig'prec_anomaly_as'datei''datef.t'.png  'dirfig'prec_anomaly_as'datei''datef.t'.png'

'printim 'dirfig'lprec_anomaly_as_'t'week.png png x800 y600'
'printim 'dirfig'prec_anomaly_as_'t'week.png png x640 y480'
'!/usr/bin/X11/convert -crop 0x0 'dirfig'prec_anomaly_as_'t'week.png  'dirfig'prec_anomaly_as_'t'week.png'
