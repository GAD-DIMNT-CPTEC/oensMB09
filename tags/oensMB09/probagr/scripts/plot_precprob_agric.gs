...
*
     ...
     '!/usr/bin/X11/convert 'dirfig'prec_agric_large'ld'.gif 'dirfig'prec_agric_large'ld'.gif'
     'printim 'dirfig'prec_agric_large'ld'.png png x900 y700'
     '!/usr/bin/X11/convert 'dirfig'prec_agric_large'ld'.png 'dirfig'prec_agric_large'ld'.png'
     ...
     '!/usr/bin/X11/convert -crop 0x0 -geometry 240x210 'dirfig'prec_agric_small'ld'.gif 'dirfig'prec_agric_small'ld'.gif'
     'printim 'dirfig'prec_agric_small'ld'.png png x900 y700'
     '!/usr/bin/X11/convert -crop 0x0 -geometry 240x210 'dirfig'prec_agric_small'ld'.png 'dirfig'prec_agric_small'ld'.png'
      nld=nld+1
