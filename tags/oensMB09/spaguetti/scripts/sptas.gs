...
*
     ...
     'draw line 4.45 1.1 4.90 1.1'
      ...
      if (VAR = 'temp')
        'printim '_DIRFIG'sptas'VAR''PLEV''DATEI''DATEF'.gif gif x640 y800'
        '!/usr/X11R6/bin/convert -crop 0x0 '_DIRFIG'sptas'VAR''PLEV''DATEI''DATEF'.gif  '_DIRFIG'sptas'VAR''PLEV''DATEI''DATEF'.png'
        'rm -f '_DIRFIG'sptas'VAR''PLEV''DATEI''DATEF'.gif  '
      endif
      if (VAR = 'zgeo')
*        'printim '_DIRFIG'sptasgeop'PLEV''DATEI''DATEF'.gif gif x800 y1000'
        'printim '_DIRFIG'sptasgeop'PLEV''DATEI''DATEF'.gif gif x640 y800'
        '!/usr/X11R6/bin/convert -crop 0x0 '_DIRFIG'sptasgeop'PLEV''DATEI''DATEF'.gif  '_DIRFIG'sptasgeop'PLEV''DATEI''DATEF'.png'
        'rm -f '_DIRFIG'sptasgeop'PLEV''DATEI''DATEF'.gif  '
      endif
