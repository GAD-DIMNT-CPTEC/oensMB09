...
C*
     ...
     *     GLAT(JMAX),CLAT(JMAX)
      ...
      INTEGER LDIM
      CHARACTER DIRL*512,DIRI*512,DIRG*512,DIRS*512,
     *          GNAMEL*512,GNAMEI*512
      CHARACTER HUM*3
C*
...
C*
     ...
     *         FORM='UNFORMATTED')
      READ(10)G
      PRINT*,'PK','MAXVAL P =',MAXVAL(G),';MINVAL P =',MINVAL(G)
      DO J=1,JMAX
      DO I=1,IMAX
      ...
      DO K=1,KMAX
      READ(10)G
      PRINT*,'PK','MAXVAL T=',MAXVAL(G),';MINVAL T=',MINVAL(G)
      DO J=1,JMAX
      DO I=1,IMAX
      T(I,J,K)=G(I,J)
      ENDDO
      ...
      DO K=1,KMAX
      READ(10)G
      PRINT*,'PK','MAXVAL Q=',MAXVAL(G),';MINVAL Q=',MINVAL(G)
      DO J=1,JMAX
      DO I=1,IMAX
      Q(I,J,K)=G(I,J)
      ...
      DO K=1,KMAX
      READ(10)G
      PRINT*,'PK','MAXVAL U=',MAXVAL(G),';MINVAL U=',MINVAL(G)
      DO J=1,JMAX
      DO I=1,IMAX
      ...
      DO K=1,KMAX
      READ(10)G
      PRINT*,'PK V','MAXVAL=',MAXVAL(G),';MINVAL V=',MINVAL(G)
      DO J=1,JMAX
      DO I=1,IMAX
