...
80  FORMAT(a91)
    ...
    DO WHILE(fname.NE.'done')
       ...
       DO ivar = 1, 12
          ...
          CALL postigge ( iunit,fname(1:lengh),varname ,ivar)
...
999 CONTINUE
  ...
  SUBROUTINE accum (ivar)
    ...
    INTEGER i,iunit,ierr,ivar,iret,kf,kr,iacc,n,ibs,nbits,ifi
    REAL SUM(ji), fact
    CHARACTER*256 varname
    ...
    !80  FORMAT(a91)
       ...
       DO WHILE(fname.NE.'done')
          ...
          ELSE
             ...
             ! kpdso(7)=jpdssuns(7,ivar)!	    (7)   - HEIGHT/PRESSURE , ETC OF LEVEL
             !          (8)   - YEAR INCLUDING (CENTURY-1)
             !          (9)   - MONTH OF YEAR
             !          (10)  - DAY OF MONTH
             !          (11)  - HOUR OF DAY
...
50     FORMAT(I4.4)
    ...
    ! KPDS(7)=jpdssuns(7,ivar)!	    (7)   - HEIGHT/PRESSURE , ETC OF LEVEL
    !          (8)   - YEAR INCLUDING (CENTURY-1)
    !          (9)   - MONTH OF YEAR
    !          (10)  - DAY OF MONTH
    !          (11)  - HOUR OF DAY
