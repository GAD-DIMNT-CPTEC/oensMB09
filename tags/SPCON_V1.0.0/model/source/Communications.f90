...
CONTAINS
  ...
  SUBROUTINE Exchange_Fields (u,v,t,q,lps,fgpass_scalar,nscalars,iold, &
    ...
    REAL(KIND=r8)   , INTENT(INOUT) :: &
                      fgpass_scalar(ibMax,kmax,jbMax_ext,nscalars,3)
    ...
    DO k=1,nsend
       ...
       do ns=m,mysendspr(2,k)
          ...
          do i=mysendsgr(1,ns),mysendsgr(2,ns)
             ...
             do n=1,nscalars
                bufsend(ibs+1:ibs+kmax)=fgpass_scalar(ibr,:,jbr,n,iold)
                ibs = ibs + kmax
             enddo
          enddo
       enddo
    ...
    DO k=1,nrec
       ...
       do ns=m,myrecspr(2,ks)
          ...
          do i=myrecsgr(1,ns),myrecsgr(2,ns)
             ...
             do n=1,nscalars
                fgpass_scalar(ibr,:,jbr,n,iold) = bufrec(ibs+1:ibs+kmax)
                ibs = ibs + kmax
             enddo
          enddo
       enddo
