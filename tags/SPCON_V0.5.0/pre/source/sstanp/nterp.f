      SUBROUTINE NTERP(FIELDA,LONIN,LATIN,FIELDB,LONOUT,LATOUT,WTLON,
     *                 WTLAT,MPLON,MPLAT,LOND,LATD,MSKIN,UNDEF,WORK)
C*
...
C*
      ...
      DO 20 I=1,LOND
      LNI=MPLON(I,1)
      IF (MSKIN(LNI,LTI) .NE. 0) THEN
      IF (FIELDA(LNI,LTI) .NE. UNDEF) THEN
      WLN=WTLON(I)
      LNO=MPLON(I,2)
