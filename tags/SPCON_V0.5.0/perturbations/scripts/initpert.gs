...
REC=FigurePlot(RESOL,LABELI,NCTLS,NMEMBR,LONW,LONE,LATNHS,LATNHN,PLEV,VAR,CTNI)
...
function FigurePlot(RESOL,DATEI,NCTLS,NMEMBR,LONW,LONE,LATNHS,LATNHN,PLEV,VAR,CTNI)
...
*     'printim ../gif/perturbations'VAR''PLEV'_'DATEI''DATEI'.png png x900 y700'
     'printim ../gif/perturbations'VAR''PLEV'_'DATEI''DATEI'.png png x720 y560'

     '!convert2 -crop 0x0 ../gif/perturbations'VAR''PLEV'_'DATEI''DATEI'.png ../gif/perturbations'VAR''PLEV'_'DATEI''DATEI'.png'
