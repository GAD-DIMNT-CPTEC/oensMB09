MODULE Pbl_UniversityWashington
  ...
  INTEGER                     :: nturb =5                   ! Number of iteration steps for calculating eddy diffusivity [ # ]
  ...
  CHARACTER,        PARAMETER :: sftype         = 'z'  !'l'           !d,l,u,z: Method for calculating saturation fraction
