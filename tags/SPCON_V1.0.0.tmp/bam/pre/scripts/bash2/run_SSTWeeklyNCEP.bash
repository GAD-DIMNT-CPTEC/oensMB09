...
##############################################################
#export dirhome=/stornext/home/paulo.kubota/agcmibis/pre
#export dirdata=/scratchin/grupos/pad/home/paulo.kubota/agcmibis
...
rec=`${dirgrads}/wgrib2 -s -YY -d 1 -order we:ns gdas1.T${hh}Z.sstgrb2.${DATA} -ieee gdas1.T${hh12}Z.sstgrd.${YYYYMMDD}${hh12}`
echo ${rec}
