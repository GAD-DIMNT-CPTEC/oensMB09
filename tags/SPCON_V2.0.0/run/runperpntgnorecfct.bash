...
echo runperreconorecfct.${MACHINE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT}
...
#
echo "${OPERM}/runperreconorecfct.${MACHINE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT} "
${OPERM}/run/runperreconorecfct.${MACHINE} ${COMPILE} ${TRC} ${LV} ${NUM} ${LABELI} ${NFDAYS} ${HUMID} ${NUMPERT}
#
