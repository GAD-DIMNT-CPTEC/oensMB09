PROGRAM ensmed
  ...
  CHARACTER(LEN=200), ALLOCATABLE :: lstoutctl(:)
  CHARACTER(LEN=200), ALLOCATABLE :: lstoutgrb(:)
  CHARACTER(LEN=200), ALLOCATABLE :: lstinctl (:,:)
  CHARACTER(LEN=200), ALLOCATABLE :: lstingrb (:,:)
