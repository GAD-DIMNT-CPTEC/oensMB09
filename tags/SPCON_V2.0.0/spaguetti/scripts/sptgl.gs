...
*
     ...
     'draw line 4.45 0.3 4.90 0.3'
      ...
      if (VAR = 'temp')
*        'printim '_DIRFIG'sptgl'VAR''PLEV''DATEI''DATEF'.gif gif x700 y900'
        'printim '_DIRFIG'sptgl'VAR''PLEV''DATEI''DATEF'.gif gif x640 y823'
        '!/usr/X11R6/bin/convert -crop 0x0 '_DIRFIG'sptgl'VAR''PLEV''DATEI''DATEF'.gif '_DIRFIG'sptgl'VAR''PLEV''DATEI''DATEF'.png'
        '!rm -f '_DIRFIG'sptgl'VAR''PLEV''DATEI''DATEF'.gif '
      endif
      if (VAR = 'zgeo')
*        'printim '_DIRFIG'sptglgeop'PLEV''DATEI''DATEF'.gif gif x700 y900'
        'printim '_DIRFIG'sptglgeop'PLEV''DATEI''DATEF'.gif gif x640 y823'
        '!/usr/X11R6/bin/convert -crop 0x0 '_DIRFIG'sptglgeop'PLEV''DATEI''DATEF'.gif '_DIRFIG'sptglgeop'PLEV''DATEI''DATEF'.png'
        '!rm -f '_DIRFIG'sptglgeop'PLEV''DATEI''DATEF'.gif '
      endif
