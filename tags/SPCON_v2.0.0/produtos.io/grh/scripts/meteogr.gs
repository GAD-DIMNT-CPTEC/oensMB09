...
_time1=subwrd(argumentos,7);_time2=subwrd(argumentos,8)

* nome do arquivo com prefixos dos pontos
_nomeb='/mpp/io_dop/tempo/global/oens/pos/dataout/TQ0126L028/2010112400/Preffix'%_labeli%_labelf%'.'%_trlv

* nomes dos arquivos com identificacao e local dos pontos
_nomec='/mpp/io_dop/tempo/global/oens/pos/dataout/TQ0126L028/2010112400/Identif'%_labeli%_labelf%'.'%_trlv
_nomed='/mpp/io_dop/tempo/global/oens/pos/dataout/TQ0126L028/2010112400/Localiz'%_labeli%_labelf%'.'%_trlv
nomectl ='/mpp/io_dop/tempo/global/oens/pos/dataout/TQ0126L028/2010112400/'%_nomea%_labeli%_labelf%'M.grh.'%_trlv%'.ctl'
*say nomectl
...
say 'printim /mpp/io_dop/tempo/global/oens/produtos/grh/dataout/TQ0126L028/2010112400/'lab'.png png'
'printim /mpp/io_dop/tempo/global/oens/produtos/grh/dataout/TQ0126L028/2010112400/'lab'.png png' 
'!rm -f meteogram'
if (_loc=1)
