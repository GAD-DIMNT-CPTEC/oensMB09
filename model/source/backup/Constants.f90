...
MODULE Constants
  ...
  INTEGER , PARAMETER :: ndavl = 106 ! Number of Available Diagnostics Fields
  INTEGER , PARAMETER :: ndrq  = 100 ! Number of Desired Diagnostics Fields
  INTEGER , PARAMETER :: ncdg  =  20 ! Number of Combined Field Components
  INTEGER , PARAMETER :: jxavl = 150 ! Maximum Number of Available plus Combined Fields
  INTEGER , PARAMETER :: jxcdg =  40 ! Maximum Number of Combined Field Components

  ! Dimension for Grid History Arrays
  INTEGER , PARAMETER :: ngfld=83 ! Number of Available Grid History Fields
