MODULE ModRadiationDriver
  ...
  USE Options, ONLY : &
       ...
       ilwrad         ,& 
       iswrad         ,& 
       crdcld, tbase, nfprt, nferr, ifozone, nfctrl

  USE Rad_COLA, ONLY:        &
       InitRadCOLA         , &
       swrad, lwrad

  USE Rad_Clirad, ONLY: cliradsw
...
!               -SwSfcNetC(i) &
       ...
       IF( StartStorDiag ) THEN          
          CALL RadDiagStor(ncols,kmax,latco,&
               ...
               delsig, gps, xSwSfcNet, xSwSfcNetC)
...
20  FORMAT(' BAD DATE IN RADTIM.  ID=',4I5,' TOD=',G16.8,' XDAY=', &
  ...
  SUBROUTINE spmrad ( &
    ...
    REAL(KIND=r8),    INTENT(in   ) :: sigbot(kmax)
    REAL(KIND=r8),    INTENT(IN   ) :: delsig(kmax)
