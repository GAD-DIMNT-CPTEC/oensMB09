...
CONTAINS
  SUBROUTINE InitReadWriteSpec(&
    ...
    INTEGER(KIND=i8) , INTENT(IN   ) :: ndrq_in
    INTEGER(KIND=i8) , INTENT(IN   ) :: ncdg_in
    INTEGER(KIND=i8) , INTENT(IN   ) :: ndavl_in
    ...
    INTEGER(KIND=i8) , INTENT(IN   ) :: nfprt_in
    INTEGER(KIND=i8) , INTENT(IN   ) :: nferr_in
    INTEGER(KIND=i8) , INTENT(IN   ) :: ifprt_in(:)
