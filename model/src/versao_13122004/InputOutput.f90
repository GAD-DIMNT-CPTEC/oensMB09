...
CONTAINS
  ...
  SUBROUTINE InitInputOutput ( &
       mMax_in, nMax_in, mnMax_in, mnMap_in, kmax_in, &
       path_in, fNameSnow_in, fNameSSTWKL_in, fNameSSTAOI_in, &
       fNameSoilms_in, fNameSibAlb_in, fNameCnfTbl, &
    ...
    OPEN (36, file=TRIM(fNameUnitTb), FORM="FORMATTED")
  ...
  SUBROUTINE getsbc (ncols,jmax,galb,gsst,gslm,gsnw,ifday,tod,&
    ...
    REAL   (KIND=r8)                :: bfra  (ncols*jmax)
    REAL   (KIND=r8)                :: bfrb  (ncols*jmax)
