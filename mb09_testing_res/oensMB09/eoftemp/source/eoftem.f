...
CCFB
C      REAL TEMPA(IMAX,JMAX,KMAX),TEMPVA(IMAX,JMAX,KMAX)
C      REAL TEMPP(IMAX,JMAX,KMAX,LMAX),UMES(IMAX,JMAX,KMAX)
C      REAL TEMPVF(IMAX,JMAX,KMAX,LMAX),PENERF(IMAX,JMAX,KMAX,LMAX)
C      REAL PENERA(IMAX,JMAX,KMAX),PENER(IMAX,JMAX,KMAX)
C      REAL PZGEO(IMAX,JMAX,KMAX)
C      REAL TAS(IMAX,JMAX,KMAX)

      REAL,ALLOCATABLE :: TEMPA(:,:,:),TEMPVA(:,:,:)
      REAL,ALLOCATABLE :: TEMPP(:,:,:,:),UMES(:,:,:)
      REAL,ALLOCATABLE :: TEMPVF(:,:,:,:),PENERF(:,:,:,:)
      REAL,ALLOCATABLE :: PENERA(:,:,:),PENER(:,:,:)
      REAL,ALLOCATABLE :: PZGEO(:,:,:)
...
CCFB
C      REAL*4 BUFP(IMAX,JMAX),BUFC(IMAX,JMAX),
C     *       BUFPN(IMAX,JMAX),BUFPAUX
C      REAL*4 TOPO(IMAX,JMAX),PSLC(IMAX,JMAX)

      REAL*4, ALLOCATABLE :: BUFP(:,:),BUFC(:,:),BUFPN(:,:)
      REAL*4  BUFPAUX
      REAL*4, ALLOCATABLE :: TOPO(:,:),PSLC(:,:)
CCFB
...
CCFB
      ALLOCATE(TEMPA(IMAX,JMAX,KMAX),TEMPVA(IMAX,JMAX,KMAX))
      ALLOCATE(TEMPP(IMAX,JMAX,KMAX,LMAX),UMES(IMAX,JMAX,KMAX))
      ALLOCATE(TEMPVF(IMAX,JMAX,KMAX,LMAX),PENERF(IMAX,JMAX,KMAX,LMAX))
      ALLOCATE(PENERA(IMAX,JMAX,KMAX),PENER(IMAX,JMAX,KMAX))
      ALLOCATE(PZGEO(IMAX,JMAX,KMAX))
      ALLOCATE(TAS(IMAX,JMAX,KMAX))
      ALLOCATE(BUFP(IMAX,JMAX),BUFC(IMAX,JMAX),BUFPN(IMAX,JMAX))
      ALLOCATE(TOPO(IMAX,JMAX),PSLC(IMAX,JMAX))
CCFB
