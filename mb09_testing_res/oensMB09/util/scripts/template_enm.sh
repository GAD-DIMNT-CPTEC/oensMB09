...
#
# !DESCRIPTION:
# Script para criar os arquivos ctl com as médias dos membros 
#
# !INTERFACE:
#      ./template_enm.sh 
#
...
# !REMARKS:
#
# Este script deve ser alocado no diretório ensmed/dataout/${resolução}
#
...
dset ^GPOSENM${data}%y4%m2%d2%h2P.fct.TQ0126L028.grb
*
index ^template.idx
*
undef 9.999E+20
